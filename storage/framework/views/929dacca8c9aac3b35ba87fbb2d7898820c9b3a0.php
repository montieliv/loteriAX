...
<div id="carouselCards" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
        <?php $__currentLoopData = $order_card; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cardId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            ...
            <div class="carousel-item <?php echo e($key === 0 ? 'active' : ''); ?>">
                <div class="card">
                    <img class="img-fluid" 
                        width="300"
                        height="450"
                         src="<?php echo e(asset('img/cards/' . $card->scrCarta)); ?>" 
                         alt="Card <?php echo e($card->nombre); ?>">
                </div>
            </div>
...
<div class="footer"><a href="CerrarSorteo/<?php echo e($sorteoID); ?>/<?php echo e($matching_cards[0]->idcarta); ?>/ <?php echo e($price_sorteo); ?>" class="btn btn-danger mb-3" style="margin-left: 3%;">Cerrar Sorteo</a><a href="/" class="btn btn-danger mb-3" style="margin-left: 3%;">Inicio</a></div>
<!-- Add required CSS -->
<style>
    .row>* {
        width: 60%;
...
const totalSlides = <?php echo e(count($order_card)); ?>;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/loteriAX/resources/views/lotteries/ejecutarSorteo.blade.php ENDPATH**/ ?>